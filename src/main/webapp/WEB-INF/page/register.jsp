...
<head>
    ...
    <title>注册</title>
    <link href="${path}/static/css/common/bootstrap.min.css" rel="stylesheet">
    <link href="${path}/static/css/register/global.css" rel="stylesheet">
    <link href="${path}/static/css/register/register.css" rel="stylesheet">
    <script src="${path}/static/js/common/jquery-3.4.1.min.js"></script>
    <script src="${path}/static/js/common/MiniDialog-es5.min.js"></script>
    <script src="${path}/static/js/register/register.js" type="text/javascript"></script>
                ...
                <div class="part1">
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            ...
                            <label class="focus" id="usernametip"><span>三字以上，不带空格和"@" (*･ω< )</span></label>
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            ...
                            <label class="f-size12 c-999 f-fl f-pl10">
                                <img id="yzm" class="yzm" src="${path}/static/img/register/yzm.jpg" alt=""/>
                            </label>
...
<script>
    ...
    function generateVerifyCode() {
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.flag) {
                    $("#yzm").attr("src", 'data:image/png;base64,' + data.resource.base64);
                    yzm = data.resource.verifyCode;
                } else {
    ...
    function usernameTipRestore() {
        ...
        $("#uns").addClass("icon-sucessfill blank hide");
        $("#usernametip").css("color", "#999");
        $("#usernametip").html("三字以上，不带空格或\"@\"就行(*･ω< )");
    }
